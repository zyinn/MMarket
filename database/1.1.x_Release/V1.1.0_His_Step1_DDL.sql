-- 联盟机构表 mm_alliance_institution_x
SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS mm_alliance_institution_x;
CREATE TABLE mm_alliance_institution_x (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='联盟机构映射表，表明联盟机构与主机构的从';



-- 用户权限表 mm_user_rights
SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS mm_user_rights;
CREATE TABLE mm_user_rights (
  id varchar(32) NOT NULL,
  user_id varchar(32) DEFAULT NULL,
  usecase varchar(64) DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY IDX_UNIQUE (user_id,usecase)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



-- rename mm_quote to mm_quote_old
alter table mm_quote rename mm_quote_old;
