(function (angular) {
    ...
    mainModule.controller('offlineFilterController', ['$uibModal', '$scope', 'areaService', 'offlineFilterService', 'tableService', 'offerService', 'enumConfig', '$cookies',
        function ($uibModal, $scope, areaService, service, tableService, offerService, enumConfig, $cookies) {
            ...
            vm.filterChanged = function (event) {
                ...
                tableService.setFilter(trust_type, areas, direction, bankNatures, fundSizes, tagCodes, tagNames);
            ...
            $scope.$on('filterReset', function (event, data) {
                ...
                tableService.setFilter(trust_type, areas, tableService.filter.direction, bankNatures, fundSizes, tagCodes, tagNames);
